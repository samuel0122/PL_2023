...
if [ $? -ne 0 ]; then
  ...
  # pruebas autocorrector: 4 puntos
  # pruebas nuevas:        6 puntos
  nota=$(echo - | awk -v A=$npruebasa -v B=$poka -v K=$pok -v P=$npruebas '{printf("%.2g",4.0*B/A+6.0*K/P)}')
  echo -e "\n\n($pok de $npruebas pruebas)\nNOTA: $nota   \n"
